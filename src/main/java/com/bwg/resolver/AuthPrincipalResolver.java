...
public class AuthPrincipalResolver implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer mavContainer,
        ...
        if (!StringUtils.hasText(authorization)) {
            ...
            return new AuthModel(null, null, null, correlationId,null,null,null,null);
        }
    ...
    private AuthModel decodeToken(String token,String correlationId) {
        try {
            ...
            return new AuthModel(token, claims.get("user_id", String.class), claims.get("email", String.class), correlationId, null,claims.get("first_name", String.class),claims.get("last_name", String.class),claims.get("profile_photo_url",String.class));
        } catch (Exception e) {
            CorrelationIdHolder.setCorrelationId(correlationId);
    ...
    private AuthModel authenticateUser(AuthModel authModel) {
        ...
        if (user == null) {
            ...
            return new AuthModel(authModel.authorization(),  user.getUserId().toString(), authModel.email(), authModel.correlationId(),role,user.getFirstName(),user.getLastName(),user.getProfilePhotoUrl());
    }
